...
import { PriceSearchTableRow } from './Row'
import { PriceSearchTableExpanded } from './Expanded'
import { Pagination } from '@/components/Pagination/Pagination'

interface PriceSearchTableProps {
	data: PriceSearchLog[]
}

const ROWS_PER_PAGE = 10

export const PriceSearchTable = ({ data }: PriceSearchTableProps) => {
					...
					<TableBody>
						...
						{paginatedData.map(log => (
							<Fragment key={log.id}>
								...
								/>
								<PriceSearchTableExpanded log={log} open={expandedId === log.id} />
							</Fragment>
						))}
					</TableBody>
				</Table>
