...
var (
	...
	ErrSearchExpired = NewDomainError(errors.New("search results expired"), http.StatusNotFound, "NF004",
	...
	ErrOrderAlreadyExists = NewDomainError(errors.New("order already exists"), http.StatusConflict, "AE002", "Заказ уже существует")
