...
func init() {
	goose.AddMigrationContext(upUpdateContentHash, downUpdateContentHash)
}

func upUpdateContentHash(ctx context.Context, tx *sql.Tx) error {
	var orderIDs []string
...
func downUpdateContentHash(ctx context.Context, tx *sql.Tx) error {
